		...
		return (
			<div style={{marginLeft: 20, marginTop: 100, flexDirection:'column', display:'flex', alignItems: 'center'}}>
				...
				<div>
					...
					<input onKeyDown={this.handleKeyDown} type= 'password' size = {100} name= 'confirmPass' value={this.state.confirmPass} onChange={e => this.onChange(e)} style={{marginBottom: 10}}/>
				...
				<div style={{flexDirection: 'row', display:'flex', justifyContent:'center'}}>
					<button
						style={{width: 80, height: 30, backgroundColor: '#abf5bc', borderRadius: 10, marginTop: 20, marginRight: 10}} 
						onClick= { e => this.onSubmit(e)}
						disabled = {newPass !==confirmPass || !isStartTyping}
					>Đổi mật khẩu</button>
					<button
						style={{width: 80, height: 30, borderRadius: 10, marginTop: 20, marginLeft: 10}} 
